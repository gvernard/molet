...
"test_2"  -  Same as 'test_0', but now the microlensing light curves will be generated from magnification maps on the fly. If the maps are missing, a download link is provided automatically.
"test_3"  -  A selected microlensing light curve trajectory from 'test_0' (index: 16), for which cutouts are also calculated.
