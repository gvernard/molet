...
FPROJECT_DIR   = lensed_extended_source/fproject
...
FP_DEPS = initFuncs.hpp polyclip.hpp polygons.hpp sourceProfile.hpp massModels.hpp sourcePlane.hpp imagePlane.hpp nonLinearPars.hpp tableDefinition.hpp covKernels.hpp fitsHeader.hpp 
